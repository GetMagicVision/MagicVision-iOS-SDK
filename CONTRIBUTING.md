We love that you’re interested in contributing to MagicVision! Any contribution is more than welcome!

## MagicVision is simple
...
```bash
open MagicVision.xcodeproj
```

## Pass Tests

In order to archive best quality, MagicVision has a lot tests to pursue this goal. After changed the code, it's better to update the tests accordingly and have all tests passed with the following command:
